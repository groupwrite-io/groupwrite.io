    ...
    <div class='container'>
      ...
      <div class='row'>
        <div class='col-md-1'>
          ...
          <div class='row'>
            <button v-if="sharedState.story.title.text" class='action-btn' title='Propose an ending to the story' v-on:click='theend' :disabled="suggestionDisabled == 1 ? true : false" v-on:keyup="syncText">The End</button>
          </div>
        </div>
        <div class='col-md-5'>
          <form>
